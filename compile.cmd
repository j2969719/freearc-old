...
@cd ..
@make
@set c_modules=%ctempdir%/Environment.o %ctempdir%/URL.o %ctempdir%/Common.o %ctempdir%/CompressionLibrary.o %ctempdir%/C_PPMD.o %ctempdir%/C_LZP.o %ctempdir%/C_LZMA.o %ctempdir%/C_BCJ.o %ctempdir%/C_GRZip.o %ctempdir%/C_Dict.o %ctempdir%/C_REP.o %ctempdir%/C_MM.o %ctempdir%/C_TTA.o %ctempdir%/C_Tornado.o %ctempdir%/C_Delta.o %ctempdir%/C_DisPack.o %ctempdir%/C_4x4.o %ctempdir%/C_External.o %ctempdir%/C_CLS.o %ctempdir%/C_Encryption.o %ctempdir%/Client7z.o -lstdc++ -lshell32 -lole32 -loleaut32 -luuid C:\Base\Compiler\ghc\gcc-lib\CRT_noglob.o -optl-s -optl-Xlinker -optl--large-address-aware
...
@set options=-iCompression -iCompression/_TABI -threaded -fglasgow-exts -XUndecidableInstances -XOverlappingInstances -XNoMonomorphismRestriction -XBangPatterns
